...
export function useTodo() {
    ...
    async function create<T extends Prisma.TodoCreateArgs>(args: Prisma.SelectSubset<T, Prisma.TodoCreateArgs>) {
        try {
            ...
            >(`${endpoint}/todo/create`, args, mutate);
        } catch (err: any) {
    ...
    async function createMany<T extends Prisma.TodoCreateManyArgs>(
        args: Prisma.SelectSubset<T, Prisma.TodoCreateManyArgs>,
    ) {
        return await request.post<Prisma.SelectSubset<T, Prisma.TodoCreateManyArgs>, Prisma.BatchPayload>(
    ...
    function findMany<T extends Prisma.TodoFindManyArgs>(
    ...
    function findUnique<T extends Prisma.TodoFindUniqueArgs>(
    ...
    function findFirst<T extends Prisma.TodoFindFirstArgs>(
    ...
    async function update<T extends Prisma.TodoUpdateArgs>(args: Prisma.SelectSubset<T, Prisma.TodoUpdateArgs>) {
        try {
            return await request.put<Prisma.SelectSubset<T, Prisma.TodoUpdateArgs>, Prisma.TodoGetPayload<T>>(
    ...
    async function updateMany<T extends Prisma.TodoUpdateManyArgs>(
        args: Prisma.SelectSubset<T, Prisma.TodoUpdateManyArgs>,
    ) {
        return await request.put<Prisma.SelectSubset<T, Prisma.TodoUpdateManyArgs>, Prisma.BatchPayload>(
    ...
    async function upsert<T extends Prisma.TodoUpsertArgs>(args: Prisma.SelectSubset<T, Prisma.TodoUpsertArgs>) {
        try {
            return await request.post<Prisma.SelectSubset<T, Prisma.TodoUpsertArgs>, Prisma.TodoGetPayload<T>>(
    ...
    async function deleteMany<T extends Prisma.TodoDeleteManyArgs>(
    ...
    function aggregate<T extends Prisma.TodoAggregateArgs>(
    ...
    function count<T extends Prisma.TodoCountArgs>(
