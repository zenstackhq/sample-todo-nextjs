...
export function useMutateSpace() {
    ...
    const invalidate = request.useInvalidation('Space', metadata);

    /** @deprecated Use `useCreateSpace` hook instead. */
    async function createSpace<T extends Prisma.SpaceCreateArgs>(args: Prisma.SelectSubset<T, Prisma.SpaceCreateArgs>) {
        return await request.mutationRequest<Prisma.SpaceGetPayload<Prisma.SpaceCreateArgs> | undefined, true>(
            'POST',
    ...
    /** @deprecated Use `useCreateManySpace` hook instead. */
    ...
    /** @deprecated Use `useUpdateSpace` hook instead. */
    async function updateSpace<T extends Prisma.SpaceUpdateArgs>(args: Prisma.SelectSubset<T, Prisma.SpaceUpdateArgs>) {
        return await request.mutationRequest<Prisma.SpaceGetPayload<Prisma.SpaceUpdateArgs> | undefined, true>(
            'PUT',
    ...
    /** @deprecated Use `useUpdateManySpace` hook instead. */
    ...
    /** @deprecated Use `useUpsertSpace` hook instead. */
    async function upsertSpace<T extends Prisma.SpaceUpsertArgs>(args: Prisma.SelectSubset<T, Prisma.SpaceUpsertArgs>) {
        return await request.mutationRequest<Prisma.SpaceGetPayload<Prisma.SpaceUpsertArgs> | undefined, true>(
            'POST',
    ...
    /** @deprecated Use `useDeleteSpace` hook instead. */
    async function deleteSpace<T extends Prisma.SpaceDeleteArgs>(args: Prisma.SelectSubset<T, Prisma.SpaceDeleteArgs>) {
        return await request.mutationRequest<Prisma.SpaceGetPayload<Prisma.SpaceDeleteArgs> | undefined, true>(
            'DELETE',
    ...
    /** @deprecated Use `useDeleteManySpace` hook instead. */
...
export function useCreateSpace(
    options?: MutationOptions<
        Prisma.SpaceGetPayload<Prisma.SpaceCreateArgs> | undefined,
        unknown,
...
export function useCreateManySpace(
    options?: MutationOptions<Prisma.BatchPayload, unknown, Prisma.SpaceCreateManyArgs>,
) {
...
export function useFindManySpace<T extends Prisma.SpaceFindManyArgs>(
    ...
    options?: QueryOptions<Array<Prisma.SpaceGetPayload<T> & { $optimistic?: boolean }>>,
) {
...
>(
    ...
    options?: InfiniteQueryOptions<Array<Prisma.SpaceGetPayload<T>>>,
) {
...
export function useFindUniqueSpace<T extends Prisma.SpaceFindUniqueArgs>(
    ...
    options?: QueryOptions<Prisma.SpaceGetPayload<T> & { $optimistic?: boolean }>,
) {
...
export function useUpdateSpace(
    options?: MutationOptions<
        Prisma.SpaceGetPayload<Prisma.SpaceUpdateArgs> | undefined,
        unknown,
...
export function useUpdateManySpace(
    options?: MutationOptions<Prisma.BatchPayload, unknown, Prisma.SpaceUpdateManyArgs>,
) {
...
export function useUpsertSpace(
    options?: MutationOptions<
        Prisma.SpaceGetPayload<Prisma.SpaceUpsertArgs> | undefined,
        unknown,
...
export function useDeleteSpace(
    options?: MutationOptions<
        Prisma.SpaceGetPayload<Prisma.SpaceDeleteArgs> | undefined,
        unknown,
...
export function useDeleteManySpace(
    options?: MutationOptions<Prisma.BatchPayload, unknown, Prisma.SpaceDeleteManyArgs>,
) {
