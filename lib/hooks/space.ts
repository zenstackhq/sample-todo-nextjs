...
export function useSpace() {
    ...
    async function create<T extends Prisma.SpaceCreateArgs>(args: Prisma.SelectSubset<T, Prisma.SpaceCreateArgs>) {
        try {
            ...
            >(`${endpoint}/space/create`, args, mutate);
        } catch (err: any) {
    ...
    async function createMany<T extends Prisma.SpaceCreateManyArgs>(
        args: Prisma.SelectSubset<T, Prisma.SpaceCreateManyArgs>,
    ) {
        return await request.post<Prisma.SelectSubset<T, Prisma.SpaceCreateManyArgs>, Prisma.BatchPayload>(
    ...
    function findMany<T extends Prisma.SpaceFindManyArgs>(
    ...
    function findUnique<T extends Prisma.SpaceFindUniqueArgs>(
    ...
    function findFirst<T extends Prisma.SpaceFindFirstArgs>(
    ...
    async function update<T extends Prisma.SpaceUpdateArgs>(args: Prisma.SelectSubset<T, Prisma.SpaceUpdateArgs>) {
        try {
            return await request.put<Prisma.SelectSubset<T, Prisma.SpaceUpdateArgs>, Prisma.SpaceGetPayload<T>>(
    ...
    async function updateMany<T extends Prisma.SpaceUpdateManyArgs>(
        args: Prisma.SelectSubset<T, Prisma.SpaceUpdateManyArgs>,
    ) {
        return await request.put<Prisma.SelectSubset<T, Prisma.SpaceUpdateManyArgs>, Prisma.BatchPayload>(
    ...
    async function upsert<T extends Prisma.SpaceUpsertArgs>(args: Prisma.SelectSubset<T, Prisma.SpaceUpsertArgs>) {
        try {
            return await request.post<Prisma.SelectSubset<T, Prisma.SpaceUpsertArgs>, Prisma.SpaceGetPayload<T>>(
    ...
    async function deleteMany<T extends Prisma.SpaceDeleteManyArgs>(
    ...
    function aggregate<T extends Prisma.SpaceAggregateArgs>(
    ...
    function count<T extends Prisma.SpaceCountArgs>(
