...
export function useList() {
    ...
    async function create<T extends Prisma.ListCreateArgs>(args: Prisma.SelectSubset<T, Prisma.ListCreateArgs>) {
        try {
            ...
            >(`${endpoint}/list/create`, args, mutate);
        } catch (err: any) {
    ...
    async function createMany<T extends Prisma.ListCreateManyArgs>(
        args: Prisma.SelectSubset<T, Prisma.ListCreateManyArgs>,
    ) {
        return await request.post<Prisma.SelectSubset<T, Prisma.ListCreateManyArgs>, Prisma.BatchPayload>(
    ...
    function findMany<T extends Prisma.ListFindManyArgs>(
    ...
    function findUnique<T extends Prisma.ListFindUniqueArgs>(
    ...
    function findFirst<T extends Prisma.ListFindFirstArgs>(
    ...
    async function update<T extends Prisma.ListUpdateArgs>(args: Prisma.SelectSubset<T, Prisma.ListUpdateArgs>) {
        try {
            return await request.put<Prisma.SelectSubset<T, Prisma.ListUpdateArgs>, Prisma.ListGetPayload<T>>(
    ...
    async function updateMany<T extends Prisma.ListUpdateManyArgs>(
        args: Prisma.SelectSubset<T, Prisma.ListUpdateManyArgs>,
    ) {
        return await request.put<Prisma.SelectSubset<T, Prisma.ListUpdateManyArgs>, Prisma.BatchPayload>(
    ...
    async function upsert<T extends Prisma.ListUpsertArgs>(args: Prisma.SelectSubset<T, Prisma.ListUpsertArgs>) {
        try {
            return await request.post<Prisma.SelectSubset<T, Prisma.ListUpsertArgs>, Prisma.ListGetPayload<T>>(
    ...
    async function deleteMany<T extends Prisma.ListDeleteManyArgs>(
    ...
    function aggregate<T extends Prisma.ListAggregateArgs>(
    ...
    function count<T extends Prisma.ListCountArgs>(
